...
def get_datas_content_label_list():
    st = time.time()
    datas = []
    datas.extend(openf('../datas/tencent/tencent.old'))
    datas.extend(openf('../datas/sina/sina.old'))
    datas.extend(openf('../datas/people/people.old'))
    datas.extend(openf('../datas/game/game.old'))
    datas.extend(openf('../datas/huanqiu/huanqiu.old'))
    datas.extend(openf('../datas/other/other.old'))
    et = time.time()
    return datas, et - st

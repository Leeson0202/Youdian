...
def get_values():
    values = [[], [], [], [], [], [], [], [], [], []]
    all_list = []
    all_list.extend(openf('datas/tencent/tencent.old'))
    all_list.extend(openf('datas/sina/sina.old'))
    all_list.extend(openf('datas/people/people.old'))
    all_list.extend(openf('datas/game/game.old'))
    all_list.extend(openf('datas/huanqiu/huanqiu.old'))
    all_list.extend(openf('datas/other/other.old'))
    for i in all_list:
